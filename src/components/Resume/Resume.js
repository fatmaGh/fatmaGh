      ...
      <div className="res-container">
        <aside>
          ...
          <p className="res-description">
            ...
            management. Also certified from GOMYCODE, I created several projects
            during the full-stack JavaScript bootcamp that i had. In addition, I
            have a professional English and French level with an intermediate
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                <p>
                  Designing and Creating websites Using Html, Css and Javascript
                </p>
              </li>
            </ul>
          </div>
